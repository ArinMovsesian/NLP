...
class MetaLife extends React.Component {
    state = {
                                        ...
                                        (value, index) => {
                                                if (value.type === 1) {
                                                    return (
                                                        ...
                                                        <ListItem noBorder style={{backgroundColor: '#FFF', borderRadius: 10, marginTop: 5, marginRight: 20, marginBottom: 5}} key={index} onPress={() => this.goToMetaLifeDetail(value.id)}>
                                                            <Body>
