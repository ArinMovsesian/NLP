...
// ];
class OfferItemsDetail extends React.Component {
    state = {
        SpinnerIcon: false,
        Images: undefined,
        Time: undefined,
                ...
                <Content padder>
                    ...
                    <List>
                        ...
                        <Button full danger onPress={this.addToShoppingCard}>
                            <Text style={{color: '#FFF', fontFamily: 'iranyekanwebregular'}}>خرید محصول ثبت نام دوره</Text>
                        </Button>
            </Container>
        )
    }
}
export default OfferItemsDetail;