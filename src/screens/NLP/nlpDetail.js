...
import {Container,Spinner,Toast, Header, Content, Accordion, Icon, View, Text, Button, List, ListItem, Left, Right, Body} from 'native-base';
...
// ];
class NLPDetail extends React.Component {
    state = {
        Title: undefined,
        Image: undefined,
        SpinnerIcon: false,
    ...
    addToShoppingCard = () => {
        AsyncStorage.getItem('token').then((value) => {
            axios.post('/Api/V1/shopping-bag',
                ...
                console.log('response nlp shopping --->',response.data);
                ...
                if (error.response) {
                    console.log('response nlp shopping-error --->',error.response.data);
