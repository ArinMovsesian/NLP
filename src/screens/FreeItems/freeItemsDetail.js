...
// ];
class FreeItemsDetail extends React.Component {
    state = {
        SpinnerIcon: false,
        // SpinnerIcon: false,
        dataArray: [
            ...
            <Container>
                    ...
                    <List>
                        {/*<ListItem noBorder style={{ backgroundColor: "#F3F3F3", marginLeft: 0, borderRadius: 10, flexDirection: 'row', justifyContent: 'flex-end'}}>*/}
                                ...
                                {/*<TouchableOpacity style={{width: 56,*/}
                                    ...
                                    {/*shadowColor: 'black',*/}
                                    {/*shadowOpacity: 1.0,}} onPress={this.downloadH}>*/}
                ...
                </Content>
                {
                    this.state.guestState === true
                        ?
                        <Button full danger onPress={this.goToHomeScreen}>
...
export default FreeItemsDetail;